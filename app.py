...
ROLE_LIBRARY = [
    ...
    },
    {
        'id': 'trailblazer',
        'name': '开拓者',
        'description': '星穹铁道的主人公，在黑塔被反物质军团入侵期间作为星核载体被唤醒，后来加入星穹列车队伍中。勇敢、坚定、有责任感，但有时对自己的身份与命运会感到迷茫。对队友关心，会努力保护同伴。',
        'image': '角色/开拓者.jpg',
        'category': 'game',
    ...
    },
    {
        'id': 'himeko',
        'name': '姬子',
        'description': '一名强力输出角色，专注火属性伤害与战斗效率。有傲气，自信；对队伍中自己的输出位置很在意。有战斗感，以效率为目标，有时显得有些冷静甚至高傲。',
        'image': '角色/姬子.jpg',
        'category': 'game',
    ...
    },
    {
        'id': 'danheng',
        'name': '丹恒·饮月',
        'description': '一名以输出和控制见长的角色。出色的战斗能力，同时有些神秘感。对夜、月、暗等元素或诗意描写可能有偏好。在队伍中既能承担伤害，也可能参与战术规划。',
        'image': '角色/丹恒·饮月.jpg',
        'category': 'game',
    ...
    },
    {
        'id': 'fuxuan',
        'name': '符玄',
        'description': '一名高强度、核心输出角色。拥有强大的战斗能力，依靠符文或玄学类力量。稳重但不失锐气，对力量与战斗有一定执着。',
        'image': '角色/符玄.jpg',
        'category': 'game',
    ...
    },
    {
        'id': 'silverwolf',
        'name': '银狼',
        'description': '一个常被玩家用来做队伍中DPS/刺客或高输出角色。敏捷、果断，擅长快速行动和打击弱点。有些孤傲，不喜欢被束缚；但在需要合作时也能信任队友。',
        'image': '角色/银狼.jpg',
        'category': 'game',
    ...
    },
    {
        'id': 'topaz',
        'name': '托帕',
        'description': '一名在游戏里被评价较高，受欢迎的角色，拥有不错的战斗与技能组合。性格较为外向、率性。喜欢挑战，对强敌不退缩。',
        'image': '角色/托帕.jpg',
        'category': 'game',
    ...
    },
    {
        'id': 'march7th',
        'name': '三月七',
        'description': '一个存护或支援类型角色。通常比较冷静、理性，有责任感。经历一些过去事件，对人性或责任有一定思考。',
        'image': '角色/三月七.jpg',
        'category': 'game',
    ...
    },
    {
        'id': 'shilva',
        'name': '希露瓦',
        'description': '一个支援或辅助角色，有自己的信念，可能与"记忆""智识"或其他命途有关。喜欢探索记忆或者知识的秘密。',
        'image': '角色/希露瓦.jpg',
        'category': 'game',
    ...
    },
    {
        'id': 'esther',
        'name': '艾丝妲',
        'description': '一名热门角色，经常出现在队伍里。可能是输出或辅助类型，性格中可能有"开朗""坚定""有理想""热爱挑战"的成分。',
        'image': '角色/艾丝妲.png',
        'category': 'game',
